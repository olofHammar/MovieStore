  ...
  const scrollRight = (e) => {
    ...
    if (title === "Top Movies") {
      ...
      let containerScrollPosition =
        document.getElementById("topMovies").scrollLeft
      container.scrollTo({
      ...
      let containerScrollPosition =
        document.getElementById("actionMovies").scrollLeft
      ...
      let containerScrollPosition =
        document.getElementById("comedyMovies").scrollLeft
      console.log(containerScrollPosition)
      container.scrollTo({
        left: containerScrollPosition + 700,
        behavior: "smooth",
      ...
      let containerScrollPosition =
        document.getElementById("documentary").scrollLeft
      console.log(containerScrollPosition)
      container.scrollTo({
        left: containerScrollPosition + 700,
        behavior: "smooth",
      ...
      let containerScrollPosition =
        document.getElementById("animatedMovies").scrollLeft
      console.log(containerScrollPosition)
      container.scrollTo({
        left: containerScrollPosition + 700,
        behavior: "smooth",
      ...
      let containerScrollPosition =
        document.getElementById("dramaMovies").scrollLeft
      console.log(containerScrollPosition)
      container.scrollTo({
        left: containerScrollPosition + 700,
        behavior: "smooth",
      ...
      let containerScrollPosition =
        document.getElementById("topfamilyMovies").scrollLeft
      console.log(containerScrollPosition)
      container.scrollTo({
        left: containerScrollPosition + 700,
        behavior: "smooth",
      ...
      let containerScrollPosition =
        document.getElementById("sciFifamilyMovies").scrollLeft
      console.log(containerScrollPosition)
      container.scrollTo({
        left: containerScrollPosition + 700,
        behavior: "smooth",
      ...
      let containerScrollPosition =
        document.getElementById("adventuresMovies").scrollLeft
      console.log(containerScrollPosition)
      container.scrollTo({
        left: containerScrollPosition + 700,
        behavior: "smooth",
      ...
      let containerScrollPosition =
        document.getElementById("familyMovies").scrollLeft
      console.log(containerScrollPosition)
      container.scrollTo({
        left: containerScrollPosition + 700,
        behavior: "smooth",
      ...
      let containerScrollPosition =
        document.getElementById("newFamilyMovies").scrollLeft
      console.log(containerScrollPosition)
      container.scrollTo({
        left: containerScrollPosition + 700,
        behavior: "smooth",
      ...
      let containerScrollPosition =
        document.getElementById("horrorMovies").scrollLeft
      console.log(containerScrollPosition)
      container.scrollTo({
        left: containerScrollPosition + 700,
        behavior: "smooth",
    ...
    <div className="row">
      ...
      <div className="buttonContainer">
        <button
          ...
          onClick={scrollLeft}
          className={rowId + " left-arrow"}
        >
          {left}
        </button>
        <button onClick={scrollRight} className={rowId + " right-arrow"}>
          {right}
        </button>
      </div>
      <div className="row_movies" id={id}>
        {movies.map((movie, i) => (
          <div className="row_movie" key={i}>
            <ContentModal
              id={movie.imdbID}
              title={movie.Title}
              poster={movie.Poster}
