...
export default function ContentModal({
  ...
  const handleRating = () => {
    ...
    db.collection("movies")
      ...
      .onSnapshot((snapshot) => {
        snapshot.docs.map(
          (doc) => ((tempRating += doc.data().rating), (count += 1))
        )
          ...
          <div className={classes.paper} id="modalContainer">
            <div className="movieContainer">
              ...
              <div className="infoContainer">
                <h2 id="transition-modal-title" className="movieTitle">
                  {title}
                </h2>
                ...
                <h5 id="transition-modal-description" className="moviePlot">
                  {plot}...
                </h5>
                      ...
                      <div className="buttonsContainer">
                        <LoginModal>
                          <button className="btnModalCart">
                            ...
                            <div id="btnCartPrice">${price}</div>
                          </button>
                        </LoginModal>

                        <TrailerModal videoId={title}>
                          <button className="btnModalTrailerLogin">
                            Trailer
                          </button>
                        </TrailerModal>
              ...
              <button className="btnModalClose" onClick={handleClose}>
                X
              </button>
            </div>
          </div>
